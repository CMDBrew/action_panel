module ActiveAdmin
  ...
  module Filters
    ...
    # Overwirte Filters::ViewHelper - activeadmin/lib/active_admin/filters/forms.rb
    module ViewHelper
      ...
      def submit_button(form)
        form.submit(I18n.t('active_admin.filters.buttons.filter'),
                    class: WrapActiveAdmin::FORM_SUBMIT_CLASS)
      end

      def cancel_button
        link_to(I18n.t('active_admin.filters.buttons.clear'), '#',
                class: "#{WrapActiveAdmin::FORM_CANCEL_CLASS} clear_filters_btn")
      end
